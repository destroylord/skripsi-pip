        ...
        <div id="sidebar">
            ...
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-center align-items-center">
                    {{-- <div class=""> --}}
                        <img src="{{ asset('img/skotga-logo.png') }}"  alt="Logo" class="w-25 h-25">
                    {{-- </div> --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#" data-bs-toggle="modal" data-bs-target="#backdrop"> <i class="bi bi-box-arrow-left"></i> Logout</a></li>
